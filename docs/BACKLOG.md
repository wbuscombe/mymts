...
- **Also deferred (LAN follow-on):** in-browser HLS video grid via `hls.js` (the same public HLS URLs the helper resolves) — left out of the LAN MVP to keep it dependency-free; the live grid lives on the TV wall.
