...
- **CRITICAL — unrelated host services:** Never touch, modify, restart, or reconfigure the unrelated host container or any VPN-related config on the NAS unless explicitly told to. This includes anything that could disrupt the VPN tunnel.
