...
data, and makes **zero outbound HTTP calls**. CI runs this test on
every push to assert the contract holds — if a future change ever
slips a network call into the phantom path, this test fails.
