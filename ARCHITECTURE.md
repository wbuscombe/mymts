...
- ~~yt-dlp channel resolution (`channels.kind = 'youtube'`)~~ — **SHIPPED** (2026-06): migration 003 widened the CHECK and the resolver is **in-process** (`import yt_dlp`), NOT the predicted out-of-process sidecar. See §24.
